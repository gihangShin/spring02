			...
			<section id="intro" class="main">
				<div class="spotlight">
					<div class="content">
						...
						<ul class="actions">
							<li><a href="insertMessage.jsp" class="button">Insert Message</a></li>
						</ul>
					</div>
			...
			<section id="first" class="main special">
				<div class="spotlight">
					<div class="content">
						...
						<ul class="actions">
							<li><a href="getMessageList.do" class="button">Show Message List</a></li>
						</ul>
					</div>
					<span class="image"><img src="images/pic01.jpg" alt="" /></span>
				</div>
